...
result = _db->exec("CREATE TABLE table10 (col1 int, col2 VARCHAR(100) COLLATE BINARY)"); 
result = _db->exec("CREATE TABLE table11(col1 int, col2 VARCHAR(100) COLLATE RTRIM)"); 
result = _db->exec("CREATE TABLE table12(col1 int, col2 VARCHAR(100) COLLATE NOCASE)"); 
