...
_stmt->bind_int(1, 25);
_stmt->bind_text16(2, s, s.GetLength(0), ZodunaDBOO_Constants::ZodunaDB_Constants::ZODUNADB_UTF8);
_stmt->step();
_db->commit();
...
s = "\u00E9\u00E9";
_stmt->bind_text16(1, s, s.GetLength(0), ZodunaDBOO_Constants::ZodunaDB_Constants::ZODUNADB_UTF8);
_stmt->step();
_db->commit();
