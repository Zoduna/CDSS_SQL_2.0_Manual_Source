...
table1 (col1 VARCHAR(100), col2 VARCHAR(100))") 

_db.begintransaction()

result = _db.exec("INSERT INTO
table1 VALUES('abcd', '1234')") 

result = _db.exec("INSERT INTO
table1 VALUES('bcde', '2345')") 

result = _db.exec("INSERT INTO
table1 VALUES('cdef', '3456')") 

_db.commit()

result
= _db.exec("SELECT json_group_object(col1, col2) FROM table1") 
