...
boolean result = _db.exec("CREATE TEMPORARY TABLE table1 (col1 int, col2 VARCHAR(100))");
result = _db.exec("CREATE TEMPORARY VIEW view1 AS SELECT col1, col2 FROM table1");
result = _db.exec("CREATE TEMP VIEW view2 AS SELECT col1, col2 FROM table1");
