...
bool result = _db.exec("CREATE TABLE table1 (col1 short, col2 varchar(100))"); 
...
{ 
	...
	Console.WriteLine("zodunadb test column 1.... type = " + column_type + ", name = " + column_name + ",  shortvalue = " + int1);
