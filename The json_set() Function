...
result
= _db.exec("SELECT json_set('{\"a\":2,\"c\":4}', '$.a', 99) FROM dumtab") 
...
result
= _db.exec("SELECT json_set('{\"a\":2,\"c\":4}', '$.e', 99) FROM dumtab") 
...
result
= _db.exec("SELECT json_set('{\"a\":2,\"c\":4}', '$.c', '[97,96]') FROM dumtab") 
...
result
= _db.exec("SELECT json_set('{\"a\":2,\"c\":4}', '$.c',
json('[97,96]')) FROM dumtab")
