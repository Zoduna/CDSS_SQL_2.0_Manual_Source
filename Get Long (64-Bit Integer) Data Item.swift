...
result = _db.exec("CREATE TABLE table1 (col1 long, col2 varchar(100))") 
...
{ 
	...
	let      long1 = _rs.getlong(1) 
	let text1 = _rs.gettext(2)
	println("zodunadb test column 1.... type = \(column_type) name = \(column_name) column value = \(long1)")
