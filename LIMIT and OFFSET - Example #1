...
result = _db.exec("INSERT into t1 values (44,
'mmmmmm4')")

result = _db.exec("INSERT into t1 values (55,
'mmmmmm5')")
...
result = _db.exec("INSERT into t1 values (33,
'mmmmmm3')")
...
ORDER BY col1 LIMIT 2 OFFSET 2")
_rs = _db.getresultset()
while (_rs.getnext() == ZODUNADB_ROW) 
{ 
                int             
