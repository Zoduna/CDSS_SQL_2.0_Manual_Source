Anything other than "true" in result means an error has happened and execution of SQL statement is unsuccessful. This statement will never create a Result Set.
...
If the return value is not "true", then this means an error has happened and execution of an SQL statement was unsuccessful.
