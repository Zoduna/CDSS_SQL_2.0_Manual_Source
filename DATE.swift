...
result = _db.exec("SELECT DATE('2010-12-31 01:00:00', '86400
...
result = _db.exec("SELECT DATE('2010-12-31 01:00:00', '-86400 seconds',
...
result = _db.exec("SELECT DATE('2010-12-31 01:00:00', 'start of
month') from dumtab ") 
_rs = _db.getresultset()
while (_rs.getnext() == ZODUNADB_ROW) 
{ 
...
result = _db.exec("SELECT DATE('now', '+86400 seconds', '+1440
