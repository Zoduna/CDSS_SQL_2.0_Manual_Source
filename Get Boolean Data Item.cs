...
bool result = _db.exec("CREATE TABLE table1 (col1 boolean, col2 varchar(100))"); 
...
{ 
	...
	Console.WriteLine("zodunadb test column 1.... type = " + column_type + ", name = " + column_name + ",  boolvalue = " + int1);
