...
SUBSTRING('mango', 0) AS 'col1' from dumtab ")
_rs = _db.getresultset()
while (_rs.getnext() == ZODUNADB_ROW) 
{ 
                let  text1 = _rs.gettext(1) 
...
result = _db.exec("SELECT
SUBSTRING('mango', 1) AS 'col1' from dumtab ")
_rs = _db.getresultset()
while (_rs.getnext() == ZODUNADB_ROW) 
{ 
                let  text1 = _rs.gettext(1) 
...
result = _db.exec("SELECT
SUBSTRING('mango', 2) AS 'col1' from dumtab ") 
_rs = _db.getresultset()
while (_rs.getnext() == ZODUNADB_ROW) 
{ 
                let  text1 = _rs.gettext(1) 
...
result = _db.exec("SELECT
SUBSTRING('mango', 3) AS 'col1' from dumtab ") 
_rs = _db.getresultset()
while (_rs.getnext() == ZODUNADB_ROW) 
{ 
                let  text1 = _rs.gettext(1) 
...
result = _db.exec("SELECT
SUBSTRING('mango', -1, 2) AS 'col1' from dumtab ") 
_rs = _db.getresultset()
while (_rs.getnext() == ZODUNADB_ROW) 
{ 
                let  text1 = _rs.gettext(1) 
...
result
= _db.exec("SELECT SUBSTRING('mango', -2, -2) AS 'col1' from dumtab ")
...
result
= _db.exec("SELECT SUBSTRING('mango', 3, -2) AS 'col1' from dumtab ")
