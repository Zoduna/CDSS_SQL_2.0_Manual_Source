...
bool result = _db.exec("CREATE TABLE table1 (col1 int, col2 date)"); 
...
{ 
	...
	Console.WriteLine("zodunadb test column 2.... type = " + column_type_2 + ", name = " + column_name_2 + ",  datevalue = " + text1); 
}
_rs.release();
_db.close();
