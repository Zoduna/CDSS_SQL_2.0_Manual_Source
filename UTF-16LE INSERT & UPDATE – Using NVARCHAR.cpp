...
_stmt->bind_int(1, 25);
_stmt-> bind_text16(2, s, s.GetLength(0), ZodunaDBOO_Constants::ZodunaDB_Constants::ZODUNADB_UTF16LE);
_stmt->step();
_db->commit();
...
_stmt-> bind_text16(1, s, s.GetLength(0), ZodunaDBOO_Constants::ZodunaDB_Constants::ZODUNADB_UTF16LE);
_stmt->step();
_db->commit();
