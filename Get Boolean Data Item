...
boolean result = _db.exec("CREATE TABLE table1 (col1 boolean, col2 varchar(100))");
...
{ 
	...
	int        int1 = _rs.getboolean(1);
	String    text1 = _rs.gettext(2);
	System.out.println("zodunadb test column 1.... type = " + column_type + ", name = " + column_name + ",  boolvalue = " + int1);
