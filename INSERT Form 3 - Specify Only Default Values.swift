...
int DEFAULT 99999, col2 VARCHAR(100) DEFAULT 'abcd')") 

_db.begintransaction()
result = _db.exec("INSERT INTO test.table1 (col1, col2)
VALUES(1234, 'abcd')") 
result = _db.exec("INSERT INTO test.table1 (col2, col1) VALUES('efgh',
2345)") 

result = _db.exec("INSERT
INTO test.table1 DEFAULT VALUES") 
_db.commit()
