...
bool result = _db.exec("CREATE TABLE table1 (col1 byte, col2 varchar(100))"); 
...
{ 
	...
	Console Console.WriteLine("zodunadb test column 1.... type = " + column_type + ", name = " + column_name + ",  bytevalue = " + int1);
