...
//use createadminuser
only one-time when configuring creating the DataStore

rc =
_db.createadminuser("myfolder/"
...
//use every time to
create the first time or open the encrypted DataStore each time the DB is opened
