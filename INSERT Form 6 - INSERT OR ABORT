...
result = _db.exec("INSERT OR ABORT INTO Customers (City, Country,
CustomerName) VALUES ('Stavanger', 'Norway', 'Cardinal')") 

result = _db.exec("INSERT OR ABORT INTO
Customers (City, Country, CustomerName) VALUES ('Stavanger', 'Norway',
'Cardinal')") 
