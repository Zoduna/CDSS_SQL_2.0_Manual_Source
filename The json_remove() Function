...
result
= _db.exec("SELECT json_remove('[0,1,2,3,4]','$[2]')
FROM dumtab") 
...
result
= _db.exec("SELECT json_remove('[0,1,2,3,4]','$[2]','$[0]')
FROM dumtab") 
...
result
= _db.exec("SELECT json_remove('[0,1,2,3,4]','$[0]','$[2]')
FROM dumtab") 
...
result
= _db.exec("SELECT json_remove('{\"x\":25,\"y\":42}') FROM dumtab") 
...
result
= _db.exec("SELECT json_remove('{\"x\":25,\"y\":42}','$.z') FROM dumtab") 
...
result
= _db.exec("SELECT json_remove('{\"x\":25,\"y\":42}','$.y') FROM dumtab") 
