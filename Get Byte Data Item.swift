...
result = _db.exec("CREATE TABLE table1 (col1 byte, col2 varchar(100))") 
_db.begintransaction()
result = _db.exec("INSERT INTO table1 VALUES(12, 'abcd')") 
result = _db.exec("INSERT INTO table1 VALUES(23, 'efgh')") 
_db.commit()
...
{ 
	...
	let        int1 = _rs.getbyte(1) 
	let text1 = _rs.gettext(2)
	println("zodunadb test column 1.... type = \(column_type) name = \(column_name), bytevalue = \(int1)")
