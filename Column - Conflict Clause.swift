...
result = _db.exec("CREATE TABLE table1 (col1 VARCHAR(100), col2
int ON CONFLICT IGNORE)") 

result = _db.exec("CREATE
UNIQUE INDEX idx1 ON table1 (col2)")

result = _db.exec("CREATE
TABLE table2 (col1 VARCHAR(100), col2 int ON CONFLICT ROLLBACK)") 

result = _db.exec("CREATE
UNIQUE INDEX idx2 ON table2 (col2)")

result = _db.exec("CREATE
TABLE table3 (col1 VARCHAR(100), col2 int ON CONFLICT REPLACE)") 

result = _db.exec("CREATE
UNIQUE INDEX idx3 ON table3 (col2)")

result = _db.exec("CREATE
TABLE table4 (col1 VARCHAR(100), col2 int ON CONFLICT ABORT)") 

result = _db.exec("CREATE
UNIQUE INDEX idx4 ON table4 (col2)")

result = _db.exec("CREATE
TABLE table5 (col1 VARCHAR(100), col2 int ON CONFLICT FAIL)") 

result = _db.exec("CREATE
UNIQUE INDEX idx5 ON table5 (col2)")
