...
boolean result = _db.exec("CREATE TABLE table1 (col1 int, col2 time)");
...
{ 
	...
	String    text1 = _rs.gettime(2);
	System.out.println("zodunadb test column 1.... type = " + column_type + ", name = " + column_name + ",  intvalue = " + int1);
	System.out.println("zodunadb test column 2.... type = " + column_type_2 + ", name = " + column_name_2 + ",  timevalue = " + text1);
}
