...
BOOL result = [_db exec:@"CREATE TABLE table1 (col1 float, col2 varchar(100))"]; 
...
{ 
	...
	int        float1 = [_rs getfloat:1]; 
	NSString*    text1 = [_rs gettext:2]; 
	printf("zodunadb test column 1.... type = %d, name = %s, floatvalue = %f\n", 
		column_type, [column_name UTF8String], float1); 
