...
result = _db.exec("CREATE TABLE table1 (col1 float, col2 varchar(100))") 
...
{ 
	...
	let       float1 = _rs. getfloat(1) 
	let text1 = _rs.gettext(2)
	println("zodunadb test column 1.... type = \(column_type) name = \(column_name) column value = \(float1)")
