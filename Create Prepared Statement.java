...
The command highlighted above creates a prepared statement which can be used to repetitively insert data into a table. 

_stmt = _db.prepare("SELECT * FROM table1 WHERE col1 = ?");
