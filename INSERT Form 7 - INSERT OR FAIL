...
result = _db.exec("CREATE TABLE oldcustomers(col1 int, col2 int, col3 int, col4 int, col5 int, col6 VARCHAR(100))")
...
result = _db.exec("INSERT OR FAIL INTO Customers AS SELECT col1, col2, col3, col4, col5, col6 FROM oldcustomers") 
_db.commit()
