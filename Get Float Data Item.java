...
boolean result = _db.exec("CREATE TABLE table1 (col1 float, col2 varchar(100))");
...
{ 
	...
	System.out.println("zodunadb test column 1.... type = " + column_type + ", name = " + column_name + ",  floatvalue = " + float1);
