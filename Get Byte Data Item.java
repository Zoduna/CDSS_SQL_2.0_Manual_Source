...
boolean result = _db.exec("CREATE TABLE table1 (col1 byte, col2 varchar(100))");
...
{ 
	...
	int        int1 = _rs.getbyte(1);
	String    text1 = _rs.gettext(2);
	ConsoleSystem.out.println("zodunadb test column 1.... type = " + column_type + ", name = " + column_name + ",  bytevalue = " + int1);
