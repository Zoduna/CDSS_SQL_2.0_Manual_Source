...
result = _db.exec("INSERT INTO table1 VALUES(5, 'efgh')");
result = _db.exec("INSERT INTO table1 VALUES(100, 'efgh')");

_db.commit();
result = _db.exec("SELECT SUM(col1), col2 FROM table1 WHERE col1 > 10 GROUP BY col2");
