...
TABLE oldcustomers(col1 int, col2 int, col3 int, col4 int, col5 int, col6
VARCHAR(100))")

result = _db.exec("CREATE
TABLE Customers(col1 int, col2 int, col3 int, col4 int, col5 int, col6
VARCHAR(100))")

result = _db.exec("CREATE
UNIQUE INDEX idx1 ON oldcustomers (col1)")

result = _db.exec("CREATE
UNIQUE INDEX idx2 ON Customers(col1)")
...
INTO oldcustomers (2, 3, 4, 5, 6, 'bcde')") 

result = _db.exec("INSERT
INTO Customers AS SELECT col1, col2, col3, col4, col5, col6 FROM oldcustomers")
