...
//following should be used in the method where
a DataStore is to be accessed
...
result = _db.exec("CREATE TABLE table1
...
_db.commit()
result = _db.exec("SELECT 'abc', col1, col2 FROM table1") 
