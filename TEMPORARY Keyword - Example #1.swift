...
result = _db.exec("CREATE
temp.TABLE table2 (col1 int, col2 varchar(100))")

result = _db.exec("CREATE
temp.TABLE table3 (col1 int, col2 varchar(100))")

result = _db.exec("CREATE
temp.TABLE IF NOT EXISTS table3 (col1 int, col2 varchar(100))")
...
result = _db.exec("CREATE TEMP TABLE table4 AS
