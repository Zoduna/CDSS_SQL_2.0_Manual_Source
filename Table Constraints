...
result = [_db exec:@"CREATE table table10 (col1 int not null, primary key (col1))"]; 
result = [_db exec:@"CREATE table table20 (col2 int, constraint key_reference foreign key (col2) references table10 (col1))"];
