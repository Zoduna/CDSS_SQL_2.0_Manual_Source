...
result = _db.exec("CREATE TABLE table1 (col1 short, col2 varchar(100))") 
...
{ 
	...
	int        int1 = _rs.getshort(1) 
	let text1 = _rs.gettext(2)
	println("zodunadb test column 1.... type = \(column_type) name = \(column_name), shortvalue = \(int1)\n")
